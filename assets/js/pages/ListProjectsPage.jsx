    ...
    archivedProjects
      ? (p) =>
          DateAPI.determineStatus(
            p.dateDebut,
            DateAPI.verifyDateExist(p.dateFinReelle)
          ) === "archived" ||
          DateAPI.determineStatus(
            p.dateDebut,
            DateAPI.verifyDateExist(p.dateFinReelle)
  ...
  const filteredProjects = filteredArchivedProjects.filter(
    (p) =>
      ...
      STATUS_LABEL[
        DateAPI.determineStatus(
          p.dateDebut,
          DateAPI.verifyDateExist(projects.dateFinReelle)
        )
      ]
        .toLowerCase()
      ...
      <div className="row">
        ...
        <div className="offset-6">
          <Button
            ...
            text={
              archivedProjects
                ? "Cacher les projets archivés"
                : "Montrer les projets archivés"
            }
        ...
        {!loading && (
          <>
            {paginationConfig.paginatedItems.length === 0 ? (
              <p className="mt-2 font-weight-bold font-italic">
                ...
                >
                  ...
                  >
                    ...
                    <div className="card-body">
                      ...
                      <p className="font-weight-light font-italic card-text">
                        {project.description}
                      </p>
                    </div>
